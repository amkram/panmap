...
class ThreadsManager {
  public:
    ...
    void calculateBreadthRatio(MgsrLiteNode* node, std::vector<std::tuple<mgsr::MgsrLiteNode*, double, double>>& breaths);
...
class mgsrPlacer {
  public:
    ...
    void scoreReadsHelper(MgsrLiteNode* node, MgsrLiteNode*& processingNode, double discard_threshold);
    void scoreReads(double discard_threshold);

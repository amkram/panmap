...
namespace mgsr {
    ...
    void scorePseudo(std::ifstream &indexFile, const std::string &reads1Path, const std::string &reads2Path, std::unordered_map<std::string, std::vector<std::tuple<int32_t, double, int32_t>>>& allScores, std::unordered_map<std::string, std::string>& leastRecentIdenticalAncestor, std::unordered_map<std::string, std::unordered_set<std::string>>& identicalSets, Tree *T, const int& maximumGap, const int& minimumCount, const int& minimumScore, int32_t ignoreEnds);
    void em(const std::unordered_map<std::string, std::vector<std::pair<int32_t, double>>>& allScores);
    void squarem(const std::unordered_map<std::string, std::vector<std::pair<int32_t, double>>>& allScores, const std::unordered_map<std::string, std::string>& leastRecentIdenticalAncestor, const std::unordered_map<std::string, std::unordered_set<std::string>>& identicalSets);
}
